...
namespace PayrollApplication {
    ...
    public partial class PayrollSystemDBDataSet : global::System.Data.DataSet {
        ...
        public partial class tblEmployeeDataTable : global::System.Data.TypedTableBase<tblEmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tblEmployeeRow AddtblEmployeeRow(int EmployeeID, string FirstName, string LastName, string Gender, string Image, System.DateTime DateOfBirth, string MaritalStatus, bool IsMember, string Address, string City, string Country) {
        ...
        public partial class tblEmployeeRow : global::System.Data.DataRow {
            ...
            public string Image {
                get {
                    return ((string)(this[this.tabletblEmployee.ImageColumn]));
                }
                set {
                    this[this.tabletblEmployee.ImageColumn] = value;
                }
            }
...
namespace PayrollApplication.PayrollSystemDBDataSetTableAdapters {
    ...
    public partial class tblEmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tblEmployee] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Gender] = @Original_Gender) AND ([Image] = @Original_Image) AND ([DateOfBirth] = @Original_DateOfBirth) AND ([MaritalStatus] = @Original_MaritalStatus) AND ([IsMember] = @Original_IsMember) AND ([Address] = @Original_Address) AND ([City] = @Original_City) AND ([Country] = @Original_Country))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tblEmployee] ([EmployeeID], [FirstName], [LastName], [Gender], [Image], [DateOfBirth], [MaritalStatus], [IsMember], [Address], [City], [Country]) VALUES (@EmployeeID, @FirstName, @LastName, @Gender, @Image, @DateOfBirth, @MaritalStatus, @IsMember, @Address, @City, @Country);
SELECT EmployeeID, FirstName, LastName, Gender, Image, DateOfBirth, MaritalStatus, IsMember, Address, City, Country FROM tblEmployee WHERE (EmployeeID = @EmployeeID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tblEmployee] SET [EmployeeID] = @EmployeeID, [FirstName] = @FirstName, [LastName] = @LastName, [Gender] = @Gender, [Image] = @Image, [DateOfBirth] = @DateOfBirth, [MaritalStatus] = @MaritalStatus, [IsMember] = @IsMember, [Address] = @Address, [City] = @City, [Country] = @Country WHERE (([EmployeeID] = @Original_EmployeeID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Gender] = @Original_Gender) AND ([Image] = @Original_Image) AND ([DateOfBirth] = @Original_DateOfBirth) AND ([MaritalStatus] = @Original_MaritalStatus) AND ([IsMember] = @Original_IsMember) AND ([Address] = @Original_Address) AND ([City] = @Original_City) AND ([Country] = @Original_Country));
SELECT EmployeeID, FirstName, LastName, Gender, Image, DateOfBirth, MaritalStatus, IsMember, Address, City, Country FROM tblEmployee WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, FirstName, LastName, Gender, Image, DateOfBirth, MaritalStatus" +
                ", IsMember, Address, City, Country FROM dbo.tblEmployee";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_FirstName, string Original_LastName, string Original_Gender, string Original_Image, System.DateTime Original_DateOfBirth, string Original_MaritalStatus, bool Original_IsMember, string Original_Address, string Original_City, string Original_Country) {
        ...
        public virtual int Insert(int EmployeeID, string FirstName, string LastName, string Gender, string Image, System.DateTime DateOfBirth, string MaritalStatus, bool IsMember, string Address, string City, string Country) {
        ...
        public virtual int Update(
            ...
            if ((Original_MaritalStatus == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[17].Value = ((string)(Original_MaritalStatus));
            }
            this.Adapter.UpdateCommand.Parameters[18].Value = ((bool)(Original_IsMember));
            if ((Original_Address == null)) {
                throw new global::System.ArgumentNullException("Original_Address");
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_City, 
                    string Original_Country) {
            return this.Update(Original_EmployeeID, FirstName, LastName, Gender, Image, DateOfBirth, MaritalStatus, IsMember, Address, City, Country, Original_EmployeeID, Original_FirstName, Original_LastName, Original_Gender, Original_Image, Original_DateOfBirth, Original_MaritalStatus, Original_IsMember, Original_Address, Original_City, Original_Country);
        }
    }
